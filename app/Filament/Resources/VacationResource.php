...
class VacationResource extends Resource
{
            ...
            ->schema([
                ...
                Placeholder::make('balance_summary')
                    ...
                    ->content(function ($get, $record) {
                        ...
                        $vacationType = VacationType::find($get('vacation_type_id'));

                        if ($vacationType && ! $vacationType->consumes_annual_entitlement) {
                            return 'Requesting '.$requestedDays.' day(s); this type does not deduct from the annual balance';
                        }
    ...
    {
        return app(VacationEntitlementService::class)
            ->remainingAnnualDays($user, now()->year, $excludeRequestId);
    }
            ...
            ->columns([
                ...
                TextColumn::make('remaining_balance')
                    ...
                    ->state(fn ($record) => $record->repUser
                        ? self::getRemainingBalance($record->repUser)
                        : null),
