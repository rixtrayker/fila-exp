...
// use App\Filament\Resources\CoverageReportResource\Pages; // Deprecated - no longer needed
...
class DeprecatedCoverageReportResource extends Resource
{
    ...
    protected static ?string $slug = 'deprecated-coverage-report';
    ...
    {
        return [
            // 'index' => Pages\ListCoverageReports::route('/'), // Deprecated - no longer needed
        ];
    }
