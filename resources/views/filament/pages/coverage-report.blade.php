<x-filament::page>
    ...
    <div class="flex text-sm" >
        ...
        <div class="flex-1 h-full border overflow-hidden rounded-lg shadow-sm text-chartgreenB @if(config('filament.dark_mode'))bg-chartgreen  border-gray-300 dark:bg-gray-800 dark:border-gray-600 @endif">
            ...
            <div
                class="p-2  @if(config('filament.dark_mode')) bg-white dark:bg-gray-800 @endif text-chartgreenB">
                {{-- Search Input --}}
        ...
        <div class="flex-1 h-full border overflow-hidden rounded-lg shadow-sm text-chartblueB @if(config('filament.dark_mode')) bg-chartblue  border-gray-300 dark:bg-gray-800 dark:border-gray-600 @endif"
        >
            {{-- Title --}}
            <p class='text-center py-4 rounded-t-lg'> Pending Visits </p>
                {{-- @if(count($this->pending)) --}}
            <div  class="p-2  @if(config('filament.dark_mode')) bg-white dark:bg-gray-800   @endif text-chartblueB">
                <ul class="overflow-y-auto"
        ...
        <div class="flex-1 h-full border overflow-hidden rounded-lg shadow-sm  text-chartredB @if(config('filament.dark_mode'))bg-chartred  border-gray-300 dark:bg-gray-800 dark:border-gray-600 @endif">
            {{-- Title --}}
            <p class='text-center py-4 rounded-t-lg'> Missed Visits </p>
            {{-- @if(count($this->missed)) --}}
            <div class="p-2  @if(config('filament.dark_mode')) bg-white dark:bg-gray-800 @endif text-chartredB" >
